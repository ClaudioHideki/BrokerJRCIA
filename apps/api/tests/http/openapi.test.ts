...
const EXPECTED_OPERATIONS = [
  ...
  'GET /v1/executions', 'GET /v1/executions/{id}', 'POST /v1/executions/{id}/cancel',
  'POST /v1/executions/{id}/retry', 'POST /v1/executions/{id}/resume',
  'POST /v1/executions/{id}/reconcile', 'GET /v1/operations/health',
  ...
  'GET /v1/channels/{id}/automation',
  'PUT /v1/channels/{id}/automation',
